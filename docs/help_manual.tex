...
\begin{verbatim}
## [1] "By cismay on Friday, September 16, 2016 17:57:15 PDT"
\end{verbatim}
...
that begins your R chunk to find the name), you were shown how to
produce a scatterplot of \texttt{Dependent1} on the vertical axis and
\texttt{Independent1} on the horizontal axis (frequently written as ``a
scatterplot of \texttt{Dependent1} versus \texttt{Independent1}). In the
GIF below, you'll see how we could produce a plot of''log base 10"
\texttt{Dependent1} versus \texttt{Independent1}. (Remember that you
first need to create the log variable.)
...
correct order. This is used to get the coefficients from a straight line
regression fit of the data. The \texttt{summary} function produces a lot
of important information about this fit.
