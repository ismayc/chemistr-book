...
\begin{verbatim}
## [1] "By cismay on Sunday, September 18, 2016 16:22:15 PDT"
\end{verbatim}
...
written as \(\log_{10}100 = 2\). It important to note that
\(log_{10}0 = -\inf\) so you'll need to be careful with how you handle
values of 0 when you calculating a logarithmic function on a vector
including 0.
